  ...
  object Scala3Library {
    ...
    val ForwardsBreakingChanges: Map[String, Seq[ProblemFilter]] = Map(
      ...
      Versions.mimaPreviousDottyVersion -> Seq(
        ...
        // STA proposal 4.13: String.splitToIArray
        ProblemFilters.exclude[DirectMissingMethodProblem]("scala.collection.StringOps.splitToIArray"),
        ProblemFilters.exclude[DirectMissingMethodProblem]("scala.collection.StringOps.splitToIArray$extension"),
    ))
