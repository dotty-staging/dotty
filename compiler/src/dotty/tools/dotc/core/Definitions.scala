...
class Definitions {
  ...
  @tu lazy val Init_UninitializedClass: Symbol = requiredModule("scala.Init").requiredType(nme.Uninitialized)
  def Init_UninitializedType: TypeRef = Init_UninitializedClass.typeRef
